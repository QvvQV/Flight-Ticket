...
public class Ticket implements Comparable<Ticket> {
    ...
    public int compareTo(Ticket o) {
        if (this.price < o.price) {         //если цена меньше, то вернуть отрицательное знач
            return -1;
        } else if (this.price > o.price) { // если цена больше, то вернуть положительное знач
            return 1;
        } else {                           //если цены равны вернуть 0
            return 0;
        }
    }
}